	...
	return (
		<section
			...
			<div
				...
				style={{
					background:
						"radial-gradient(ellipse at 30% 50%, rgba(20,20,20,0.4) 0%, rgba(0,0,0,0.95) 70%)",
					zIndex: 2,
				}}
			/>
			...
			<div className='relative z-10 w-full px-10 md:px-16 lg:px-20'>
				<div className='ml-auto w-full md:w-[60%] lg:w-[55%]'>
					...
					<p
						...
						Currently building digital experiences and pushing
						personal limits. When not writing code, you will find me
						on the open road, under a barbell, or tending to my
						birds.
					</p>
				</div>
			</div>
